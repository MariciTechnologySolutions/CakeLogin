(function() {
    ...
    a = jQuery, b = function() {
        ...
        return c.settings = {
            ...
            return null == a && (a = this.$growl()), a.on("click", this.click), a.on("contextmenu", this.close).find("." + this.settings.namespace + "-close").on("click", this.close)
        }, c.prototype.unbind = function(a) {
            return null == a && (a = this.$growl()), a.off("click", this.click), a.off("contextmenu", this.close).find("." + this.settings.namespace + "-close").off("click", this.close)
